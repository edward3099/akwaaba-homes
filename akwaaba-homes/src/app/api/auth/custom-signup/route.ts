...
export async function POST(request: NextRequest) {
  try {
    ...
    const confirmationUrl = `${process.env.NEXT_PUBLIC_SITE_URL || 'https://akwaaba-homes-dib5f4i4g-eds-projects-934496ce.vercel.app'}/auth/confirm?token_hash=${data.user.id}&type=email`;
