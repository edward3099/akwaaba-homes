...
export async function POST(request: NextRequest) {
  try {
    console.log('🎯 Admin property approval API called');
    ...
    console.log('📝 Processing property approval:', {
    ...
    console.log('✅ Property status updated successfully:', newStatus);
    ...
    if (logError) {
      console.error('⚠️ Error logging admin action:', logError);
