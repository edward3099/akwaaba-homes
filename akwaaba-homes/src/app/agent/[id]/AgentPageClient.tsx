                  ...
                  <div className="flex items-center gap-1">
                    ...
                    <div className="flex-1 text-white">
                      <div className="flex items-center gap-1 mb-0.5">
                        ...
                        <Badge variant="secondary" className="text-xs px-1 py-0 bg-white/20 text-white border-white/30">agent</Badge>
                      </div>
                      <p className="text-white/90 text-xs">{agent.company}</p>
                    ...
                    <div className="flex gap-1">
                      <Button variant="outline" size="sm" className="bg-white/90 hover:bg-white h-4 px-1.5 text-xs border-white/30">
