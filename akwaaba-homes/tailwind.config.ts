...
const config: Config = {
  ...
  theme: {
    screens: {
      'xs': '475px',
      '2xs': '375px', // Extra small mobile devices
    },
    extend: {
      colors: {
        ...
        ghana: {
          ...
          star: "#000000",    // Black star
        },
        // Real estate themed colors
        property: {
          sale: "#059669",     // Green for sales
          rent: "#3B82F6",     // Blue for rentals
          sold: "#6B7280",     // Gray for sold
          featured: "#F59E0B", // Amber for featured
